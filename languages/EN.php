...
$TXT_BAKERY['SHOP_STATE'] = 'Shop State';
...
$TXT_BAKERY['SHOW_STATE_FIELD'] = 'Show State Field';
$TXT_BAKERY['SHOW_TAX_NO_FIELD'] = 'Show VAT No Field';
$TXT_BAKERY['SHOW_ZIP_END_OF_ADDRESS'] = 'ZIP at End of Address';
...
$TXT_BAKERY['SKIP_CART_AFTER_ADDING_ITEM'] = 'Skip cart view after adding item to cart';
...
$TXT_BAKERY['SHIPPING_BASED_ON'] = 'Shipping based on';
...
$TXT_BAKERY['SHIPPING_METHOD_HIGHEST'] = 'Item with the highest Shipping Cost';
$TXT_BAKERY['SHIPPING_METHOD_NONE'] = 'none';
$TXT_BAKERY['FREE_SHIPPING'] = 'Free Shipping';
$TXT_BAKERY['OVER'] = 'over';
$TXT_BAKERY['SHOW_FREE_SHIPPING_MSG'] = 'Inform Customers about free Shipping Limit';
...
$TXT_BAKERY['EG_OPTION_NAME'] = 'eg. color';
$TXT_BAKERY['EG_OPTION_ATTRIBUTE'] = 'eg. red';
$TXT_BAKERY['INCL'] = 'Inclusive';
$TXT_BAKERY['EXCL_SHIPPING'] = 'excluding Shipping';
$TXT_BAKERY['EXCL_SHIPPING_TAX'] = 'excluding Shipping and Tax';
$TXT_BAKERY['TAX'] = 'Tax';
$TXT_BAKERY['QUANTITY'] = 'Quantity';
$TXT_BAKERY['SUM'] = 'Sum';
$TXT_BAKERY['SUBTOTAL'] = 'Subtotal';
$TXT_BAKERY['TOTAL'] = 'Total';
$TXT_BAKERY['SHIPPING'] = 'Shipping';
...
$TXT_BAKERY['ADD_TO_CART'] = 'Add to cart';
$TXT_BAKERY['VIEW_CART'] = 'View cart';
$TXT_BAKERY['UPDATE_CART'] = 'Update cart';
$TXT_BAKERY['UPDATE_CART_SUCCESS'] = 'Cart was updated successfully.';
...
$TXT_BAKERY['CANCEL'] = 'You have canceled your Order.';
...
$TXT_BAKERY['CUST_STATE'] = 'State';
$TXT_BAKERY['CUST_COUNTRY'] = 'Country';
$TXT_BAKERY['CUST_ZIP'] = 'Zip';
...
$TXT_BAKERY['STATUS_CANCELED'] = 'canceled';
...
$TXT_BAKERY['ERR_CART_EMPTY'] = 'The shopping cart is empty.'; 
$TXT_BAKERY['ERR_ITEM_EXISTS'] = 'This item is already present in your cart.<br />You can change the quantity in the shopping cart.';
...
$TXT_BAKERY['ERR_INVAL_STATE'] = 'is not a valid state.';
...
$TXT_BAKERY['SEND_COPY_TO_CLIENT'] = 'Send a copy of the request to the email address above'; //new
$TXT_BAKERY['REQUEST_EMAIL_SUBJECT_CLIENT'] = "Thank you for your request (ref. no. [ORDER_ID]) to [SHOP_NAME]";  //new
$TXT_BAKERY['REQUEST_EMAIL_BODY_CLIENT'] = "This is the data we received from you:";  //new
$TXT_BAKERY['CUST_MOBILE'] = 'Mobile phone';
$TXT_BAKERY['ADD_TO_REQEST_LIST'] = 'Add to request list';