...
<div class="grid">
   <div class="unit whole">
      <h3 class="mod_bakery_pay_h_f"><?=$TXT_BAKERY[$payment_method]['TITLE']; ?> <img src="<?=WB_URL ?>/modules/bakery/images/mastercard.gif" alt="Logo Mastercard" width="37" height="21" /><img src="<?=WB_URL ?>/modules/bakery/images/visa.gif" alt="Logo Visa" width="37" height="21" /><img src="<?=WB_URL ?>/modules/bakery/images/amex.gif" alt="Logo American Express" width="37" height="21" /></h3>
   </div>
</div>
<div class="grid">
   <div class="unit whole"><?=$TXT_BAKERY[$payment_method]['PAY_ONLINE_1']; ?><br />
      <?=$TXT_BAKERY[$payment_method]['SECURITY']; ?><a href="<?=$security_info_url ?>" target="_blank"> &raquo; <?=$TXT_BAKERY[$payment_method]['WEBSITE']; ?></a>.
   </div>
</div>
