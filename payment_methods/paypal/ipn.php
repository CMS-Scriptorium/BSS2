...
if (strcmp($res, 'VERIFIED') == 0) {
	...
	$shop_currency = $database->get_one("SELECT shop_currency FROM {BXT}_general_settings");
	...
	$paypal_email = $database->get_one("SELECT value_1 FROM {BXT}_payment_methods WHERE directory = 'paypal'");
	...
	if ($error != true) {
		...
		$database->query("UPDATE {BXT}_customer SET transaction_id = '$txn_id', transaction_status = 'paid' WHERE order_id = '$order_id' AND transaction_id = 'none' AND transaction_status IN ('none','pending')");
	...
	// ERROR
		...
		$database->query("UPDATE {BXT}_customer SET transaction_id = '$txn_id', transaction_status = 'pending' WHERE order_id = '$order_id' AND transaction_id = 'none' AND transaction_status = 'none'");
		$payment_method  = 'paypal';
