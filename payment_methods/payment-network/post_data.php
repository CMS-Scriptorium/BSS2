...
$query_payment_methods = $database->query("SELECT value_1, value_2, value_3, value_4, value_5, value_6 FROM {BXT}_payment_methods WHERE directory = '$payment_method'");
...
$query_customer = $database->query("SELECT order_date FROM {BXT}_customer WHERE order_id = '$order_id'");
...
$post_data = array(
	...
	'amount'                  => $_SESSION['bxt']['order_total'],
	'currency_id'             => $setting_shop_currency,
	'reason_1'                => $TXT_BAKERY['ORDER'].' '.$setting_shop_name,
	'reason_2'                => $TXT_BAKERY['ORDER_ID'].': '.$order_id,
