...
$TXT_BAKERY[$payment_method]['NAME'] = 'Fattura';
$TXT_BAKERY[$payment_method]['BANK_ACCOUNT'] = 'Conto Bancario Negozio';
$TXT_BAKERY[$payment_method]['TXT_INVOICE_TEMPLATE'] = 'Modello Fattura';
$TXT_BAKERY[$payment_method]['INVOICE_ALERT'] = '1. Notifica Sollecito dopo';
$TXT_BAKERY[$payment_method]['REMINDER_ALERT'] = '2. Notifica Sollecito dopo';

// USED BY FILE bakery/payment_methods/invoice/gateway.php
$TXT_BAKERY[$payment_method]['TITLE'] = 'Fattura';
$TXT_BAKERY[$payment_method]['ACCOUNT'] = 'La preghiamo di pagare il saldo dovuto al nostro conto bancario rispettando le condizioni del pagamento.';
$TXT_BAKERY[$payment_method]['PAY'] = 'Addebita sul mio Account';

// USED BY FILE bakery/checkout_confirmation.php
$TXT_BAKERY[$payment_method]['SUCCESS'] = 'Le invieremo una email con la conferma dell\'ordine.';
$TXT_BAKERY[$payment_method]['SHIPMENT'] = 'Le spediremo l\'ordine il pi&ugrave; presto possibile.';
...
// EMAIL CUSTOMER
$TXT_BAKERY[$payment_method]['EMAIL_SUBJECT_CUSTOMER'] = 'Conferma del suo ordine su [SHOP_NAME]';
