...
// Delete attribute
$database->query("DELETE FROM {BXT}_attributes WHERE attribute_id = '$attribute_id'");
$database->query("DELETE FROM {BXT}_item_attributes WHERE attribute_id = '$attribute_id'");
