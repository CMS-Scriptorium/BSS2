...
<head>
<title><?=$TXT_BAKERY['ORDER'].' '.$TEXT['VIEW_DETAILS']; ?></title>
...
if ($query_customer->numRows() > 0) {
	...
	if (!empty($customer['invoice'])) {
		...
		$display_tax_no   = empty($cust_tax_no)       ? 'none'             : 'block';

		// If given get customers message
		$cust_msg         = isset($invoice_array[16]) ? nl2br($invoice_array[16]) : '';
		$display_cust_msg = empty($cust_msg)          ? 'none'                    : 'block';
...
<div id="order">
  <table width="540px" align="center" border="0" cellspacing="0" cellpadding="3">
	<tr>
	  <td colspan="6">
	    <span class="mod_bakery_order_b"><?=$TXT_BAKERY['ORDER_ID']."</span>: ".$order_id; ?><br />
	    <span class="mod_bakery_order_b"><?=$TXT_BAKERY['INVOICE_ID']."</span>: ".$invoice_id; ?><br />
		<span class="mod_bakery_order_b"><?=$TXT_BAKERY['ORDER_DATE']."</span>: ".$order_date; ?></td>
	</tr>
	<tr>
	  <td colspan="6">
		<table width="98%" border="0" cellspacing="0" cellpadding="6">
		  <tr>
			<td valign="top" width="10%"><span class="mod_bakery_address_b"><?=$TXT_BAKERY['ADDRESS']; ?></span></td> 
			<td valign="top" width="30%"><?=$cust_address; ?></td>
			<td width="4%">&nbsp;</td>
			<td valign="top" width="10%"><span class="mod_bakery_address_b"><?=$TXT_BAKERY['SHIP_ADDRESS']; ?></span></td>
			<td valign="top"><?=$ship_address; ?></td>
		  </tr>
		  <tr style="display: <?=$display_tax_no; ?>;">
		  	<td><span class="mod_bakery_tax_no_b"><?=$TXT_BAKERY['CUST_TAX_NO']; ?></span></td>
		  	<td colspan="4"><?=$cust_tax_no; ?></td>
		  </tr>
		</table>
	  </td>
	</tr>
    <tr>
	  <td colspan="6"><?=$html_item_list; ?></td>
	</tr>
	<tr style="display: <?=$display_cust_msg; ?>;">
	  <td colspan="6">
		<table width="98%" border="0" cellspacing="0" cellpadding="6">
		  <tr>
			<td valign="top" width="25%"><span class="mod_bakery_address_b"><?=$TXT_BAKERY['CUST_MESSAGE']; ?></span></td> 
			<td valign="top"><?=$cust_msg; ?></td>
		  </tr>
		</table>
	  </td>
	</tr>
	<tr id="button" valign="top">
	  ...
	  <td colspan="3" height="30" align="right" style="padding-right: 12px;">
	    <input type="button" value="<?=$TEXT['CLOSE']; ?>" onclick="javascript: window.close();" style="width: 120px; margin-top: 5px;" />
	  </td>
	</tr>
  </table>
</div>
