...
CREATE TABLE IF NOT EXISTS `{BXT}_customer` (
    ...
    `cust_company`          VARCHAR(64) NULL DEFAULT '',
    `cust_first_name`       VARCHAR(64) NULL DEFAULT '',
    `cust_last_name`        VARCHAR(64) NULL DEFAULT '',
    `cust_tax_no`           VARCHAR(11) NULL DEFAULT '',
    `cust_street`           VARCHAR(64) NULL DEFAULT '',
    ...
    `cust_city`             VARCHAR(64) NULL DEFAULT '',
    `cust_state`            VARCHAR(64) NULL DEFAULT '',
    `cust_country`          VARCHAR(2) NULL DEFAULT '',
    `cust_zip`              VARCHAR(10) NULL DEFAULT '',
    `cust_email`            VARCHAR(64) NULL DEFAULT '',
    `cust_phone`            VARCHAR(20) NULL DEFAULT '',
    `cust_mobile`           VARCHAR(32) NOT NULL,            /* NEW since vers. 2.0.0 */
    `ship_company`          VARCHAR(64) NULL DEFAULT '',
    `ship_first_name`       VARCHAR(64) NULL DEFAULT '',
    `ship_last_name`        VARCHAR(64) NULL DEFAULT '',
    `ship_street`           VARCHAR(64) NULL DEFAULT '',
    ...
    `ship_city`             VARCHAR(64) NULL DEFAULT '',
    `ship_state`            VARCHAR(64) NULL DEFAULT '',
    `ship_country`          VARCHAR(2) NULL DEFAULT '',
    `ship_zip`              VARCHAR(10) NULL DEFAULT '',
