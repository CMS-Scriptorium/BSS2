...
$page_id_help = isset($_GET['page_id']) ? strip_tags($_GET['page_id']) : '';
$section_id_help = isset($_GET['$section_id']) ? strip_tags($_GET['$section_id']) : '';
...
$query_general_settings = $database->query("SELECT * FROM {BXT}_general_settings");
if ($query_general_settings->numRows() > 0) {
	$general_settings = $query_general_settings->fetchRow();
	$general_settings = array_map('lazystrip', $general_settings);
}

// Get page settings
$query_page_settings = $database->query("SELECT * FROM {BXT}_page_settings WHERE page_id = '$page_id_help'");
...
// Get continue url
$query_continue_url = $database->query("SELECT p.link FROM {TP}pages p INNER JOIN {BXT}_page_settings ps ON p.page_id = ps.page_id WHERE p.page_id = ps.continue_url AND ps.section_id = '$section_id_help'");
if ($query_continue_url->numRows() > 0) {
	$fetch_continue_url = $query_continue_url->fetchRow();
	$continue_url = lazystrip($fetch_continue_url['link']);
}

// Get customer data
$query_customer = $database->query("SELECT invoice_id, invoice FROM {BXT}_customer WHERE submitted != 'no' ORDER BY order_id DESC LIMIT 1");
...
// Get items
$query_item = $database->query("SELECT * FROM {BXT}_items ORDER BY item_id DESC LIMIT 1");
...
// Get page info
$query_page = $database->query("SELECT * FROM {TP}pages WHERE page_id = '$page_id_help'");
...
// Display text message	
	...
	if ($item['stock'] < 1) {
		$stock = $TXT_BAKERY['OUT_OF_STOCK'];
	} elseif ($item['stock'] > $general_settings['stock_limit']) {
		$stock = $TXT_BAKERY['IN_STOCK'];
	} else {
		$stock = $TXT_BAKERY['SHORT_OF_STOCK'];
	}
// Display nothing
} else {
	$stock = '';
...
<html>
<head>
<link rel="stylesheet" type="text/css" href="<?php echo WB_URL; ?>/modules/bakery/backend.css">
  ...
  <tr>
    ...
    <td><blockquote><strong>Output Example Data</strong></blockquote>
	  <ul>
		...
		<li><span class="mod_bakery_placeholders_page_settings_b">Brown: Page settings (example page id = <?=$page_id_help; ?>)</span></li>
		<li><span class="mod_bakery_placeholders_customer_b">Red: Order and Customer (example order id = <?=(isset($order_id) ? $order_id : $TEXT['NONE_FOUND']); ?>)</span></li>
		<li><span class="mod_bakery_placeholders_items_b">Orange: Item (example item id = <?=(isset($item['item_id']) ? $item['item_id'] : $TEXT['NONE_FOUND']); ?>)</span></li>
		<li><span class="mod_bakery_placeholders_page_b">Pink: Page (example page id = <?=$page_id_help; ?>)</span></li>
      </ul>
	</td>
  </tr>
</table>
...
<table  id="mod_bakery_placeholders_b" width="100%" cellpadding="5" cellspacing="0">
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['ADD_TO_CART']; ?></td>
  </tr>
  <tr valign="top">
    <td>[BACK]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_page_b"><?=(isset($page['link']) ? WB_URL."<wbr>".PAGES_DIRECTORY.$page['link'].PAGE_EXTENSION : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[CURRENCY]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_general_settings_b"><?=(isset($general_settings['shop_currency']) ? $general_settings['shop_currency'] : "USD"); ?></td>
  </tr>
  <tr valign="top">
    <td>[DATE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['modified_when']) ? gmdate(DATE_FORMAT, $item['modified_when']+TIMEZONE) : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[DESCRIPTION]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['description']) ? $item['description'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[DISPLAY_NAME]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td><?=(isset($_SESSION['DISPLAY_NAME']) ? $_SESSION['DISPLAY_NAME'] : "Administrator"); ?></td>
  </tr>
  <tr valign="top">
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['definable_field_0']) ? $item['definable_field_0'] : ''); ?></td>
  </tr>
  <tr valign="top">
    <td>[FULL_DESC]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['full_desc']) ? $item['full_desc'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[IMAGE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>Item id</td>
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['item_id']) ? $item['item_id'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[LINK]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['link']) ? WB_URL.PAGES_DIRECTORY."<wbr>".$item['link'].PAGE_EXTENSION : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[NEXT]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><a><?=$TEXT['NEXT']; ?> &gt;&gt;</a></td>
  </tr>
  <tr valign="top">
    <td>[NEXT_LINK]</td>
    <td class="mod_bakery_placeholders_column_b">PH</td>
    ...
    <td class="mod_bakery_placeholders_page_b"><a><?=$TEXT['NEXT']; ?> &gt;&gt;</a></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    <td>Link to the next page</td>
    <td class="mod_bakery_placeholders_page_b"><a><?=$TEXT['NEXT_PAGE']; ?> &gt;&gt;</a></td>
  </tr>
  <tr valign="top">
    <td>[OF]</td>
    <td class="mod_bakery_placeholders_column_b">PH</td>
    ...
    <td class="mod_bakery_placeholders_general_settings_b">1-3 <?=$TEXT['OF']; ?> 10 </td>
  </tr>
  <tr valign="top">
    <td>[OPTION]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_items_b">2 <?=$TEXT['OUT_OF']; ?> 10 </td>
  </tr>
  <tr valign="top">
    <td>[PAGE_TITLE]</td>
    <td class="mod_bakery_placeholders_column_b">PH</td>
    ...
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>Page title</td>
    <td class="mod_bakery_placeholders_page_b"><?=(isset($page['page_title']) ? $page['page_title'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[PREVIOUS]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><a>&lt;&lt; <?=$TEXT['PREVIOUS']; ?></a></td>
  </tr>
  <tr valign="top">
    <td>[PREVIOUS_LINK]</td>
    <td class="mod_bakery_placeholders_column_b">PH</td>
    ...
    <td class="mod_bakery_placeholders_page_b"><a>&lt;&lt; <?=$TEXT['PREVIOUS']; ?></a></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    <td>Link to the previous page</td>
    <td class="mod_bakery_placeholders_page_b"><a>&lt;&lt; <?=$TEXT['PREVIOUS_PAGE']; ?></a></td>
  </tr>
  <tr valign="top">
    <td>[PRICE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>Item Price</td>
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['price']) ? $item['price'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[SHIPPING]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>Item Shipping</td>
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['shipping']) ? $item['shipping'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_general_settings_b"><?=(isset($general_settings['shipping_domestic']) ? $general_settings['shipping_domestic'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_general_settings_b"><?=(isset($general_settings['shipping_abroad']) ? $general_settings['shipping_abroad'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[SHIPPING_D_A]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_general_settings_b"><?=(isset($general_settings['shipping_domestic']) && isset($general_settings['shipping_abroad']) ? $general_settings['shipping_domestic'].'/'.$general_settings['shipping_abroad'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[SHOP_URL]</td>
    <td class="mod_bakery_placeholders_column_b">PH</td>
    ...
    <td class="mod_bakery_placeholders_page_settings_b"><?=(isset($continue_url) ? WB_URL.PAGES_DIRECTORY."<wbr>".$continue_url.PAGE_EXTENSION : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[SKU]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['sku']) ? $item['sku'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[STOCK]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><?=$stock; ?></td>
  </tr>
  <tr valign="top">
    <td>[TAX_RATE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>Item Tax Rate</td>
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['tax_rate']) ? $item['tax_rate'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[TEXT_OF]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TEXT['OF']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TEXT_OUT_OF]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TEXT['OUT_OF']; ?></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TEXT['READ_MORE']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_ABROAD]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['ABROAD']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_BACK]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TEXT['BACK']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_DOMESTIC]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['DOMESTIC']; ?></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_general_settings_b"><?=(isset($general_settings['definable_field_0']) ? $general_settings['definable_field_0'] : ''); ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_FULL_DESC]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['FULL_DESC']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_ITEM]</td>
    <td class="mod_bakery_placeholders_column_b">PH</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['ITEM']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_PRICE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['PRICE']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_SHIPPING]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['SHIPPING']; ?></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['SHIPPING_COST']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_SKU]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['SKU']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_STOCK]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['STOCK']; ?></td>
  </tr>
  <tr valign="top">
    <td>[TXT_TAX_RATE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['TAX_RATE']; ?></td>
  </tr>
  <tr valign="top">
    <td>[THUMB]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['modified_when']) ? gmdate(TIME_FORMAT, $item['modified_when']+TIMEZONE) : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[TITLE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_items_b"><?=(isset($item['title']) ? $item['title'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[USERNAME]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>User name</td>
    <td><?=(isset($_SESSION['USERNAME']) ? $_SESSION['USERNAME'] : "admin"); ?></td>
  </tr>
  <tr valign="top">
    <td>[USER_ID]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
    ...
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>User id</td>
    <td><?=(isset($_SESSION['USER_ID']) ? $_SESSION['USER_ID'] : "1"); ?></td>
  </tr>
  <tr valign="top">
    <td>[VIEW_CART]</td>
    <td class="mod_bakery_placeholders_column_b">PH</td>
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['VIEW_CART']; ?></td>
  </tr>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($address) ? $address : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[BANK_ACCOUNT]</td>
    <td colspan="6">Information about the shop bank account (general setting)</td>
    <td class="mod_bakery_placeholders_general_settings_b"><?=(isset($general_settings['bank_account']) ? $general_settings['bank_account'] : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[CUST_ADDRESS]</td>
    ...
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($cust_address) ? $cust_address : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[CUST_EMAIL]</td>
    <td colspan="6">Customer email address</td>
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($cust_email) ? $cust_email : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[CUST_MSG]</td>
    <td colspan="6">Customers message: Notice written by the customer is sent to the shop admin by email</td>
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($cust_msg) ? $cust_msg : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[CUST_TAX_NO]</td>
    <td colspan="6">Customer VAT-No</td>
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($cust_tax_no) ? $cust_tax_no : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[CUSTOMER_NAME]</td>
    <td colspan="6">Customer first and last name</td>
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($cust_name) ? $cust_name : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[ITEM_LIST]</td>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($order_id) ? $order_id : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($ship_address) ? $ship_address : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[SHOP_NAME]</td>
    <td colspan="6">Shop name (general setting)</td>
    <td class="mod_bakery_placeholders_general_settings_b"><?=(isset($general_settings['shop_name']) ? $general_settings['shop_name'] : '&nbsp;'); ?></td>
  </tr>
  ...
  <tr valign="top">
    <td>[ADDRESS]</td>
    <td colspan="6"><strong>Either</strong> the value of <code>[CUST_ADDRESS]</code> <strong>or</strong> -  if provided by the customer - the value of <code>[SHIPPING_ADDRESS]</code></td>
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($invoice_tpl_address) ? $invoice_tpl_address : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[BANK_ACCOUNT]</td>
    <td colspan="6">Information about the shop bank account (general setting)</td>
...
Contains the customer postal address of the first part of the  Bakery address form. It is the main address and used for billing and - if no shipping address is provided by the customer - for shipping as well.</td>
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($invoice_tpl_cust_address) ? $invoice_tpl_cust_address : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[CUST_EMAIL]</td>
    <td colspan="6">Customer email address</td>
...
Invoice and delivery note: &quot;none&quot;</td>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_customer_b"><?=(!empty($invoice_id) ? $invoice_id : '&nbsp;'); ?></td>
  </tr>
...
*****************************************
<?=(isset($html_item_list) ? $html_item_list : "No example available."); ?> 
-->
    </span></td>
  </tr>
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_customer_b"><?=(isset($order_date) ? $order_date : '&nbsp;'); ?></td>
  </tr>
  <tr valign="top">
    <td>[ORDER_ID]</td>
    <td colspan="6">Order id</td>
...
It is used for shipping only.</td>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_localisation_b"><?=$TXT_BAKERY['INVOICE']; ?><br /><?=$TXT_BAKERY['DELIVERY_NOTE']; ?><br /><?=$TXT_BAKERY['REMINDER']; ?></td>
  </tr>
  <tr valign="top">
    <td>[WB_URL]</td>
    <td colspan="6">WBCE URL (used for invoice logo)</td>
    <td><?=WB_URL; ?></td>
  </tr>
  <tr valign="bottom">
